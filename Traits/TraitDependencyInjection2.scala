object TraitDependencyInjection2 extends App {
  ...
  trait MainController {
    ...
    class MainControllerImpl {
      def printCurrentTime() =
        println(timeUtil.now()) //timeUtil is injected from TimeUtil trait
    }
  }

  object MainApp extends App {
    object app extends MainController with TimeUtil //wire all components
