...
object FunctionAsValues_Tutorial extends App {
  ...
  def totalCostWithDiscountFunctionParameter(
      donutType: String
  )(quantity: Int)(f: Double => Double): Double = {
  ...
  println(
    s"Total cost of 5 Glazed Donuts with discount def function = ${totalCostWithDiscountFunctionParameter("Glazed Donut")(5)(applyDiscount(_))}"
  )
...
//  val applyDiscountValueFunction: Double => Double = totalCost => { // val function syntax with return type
  ...
  println(
    s"Total cost of 5 Glazed Donuts with discount val function = ${totalCostWithDiscountFunctionParameter("Glazed Donut")(5)(applyDiscountValueFunction)}"
  )
}
