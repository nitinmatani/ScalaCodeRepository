import com.allaboutscala.chapter.four.Covariance_Tutorial.{
  GlazedDonut,
  VanillaDonut
}
...
object ContraVariance_Tutorial extends App {
  ...
  val shoppingCart: ShoppingCart[Donut] = new ShoppingCart(
    Seq[Donut](vanillaDonut, glazedDonut)
  )
  ...
  val shoppingCart2: ShoppingCart2[VanillaDonut] =
    new ShoppingCart2[Donut](Seq(glazedDonut))
