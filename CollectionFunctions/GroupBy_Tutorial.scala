...
object GroupBy_Tutorial extends App {
  ...
  println(
    s"Group elements in the donut sequence by the first letter of the donut name = $donutsGroup"
  )
  ...
  println(
    s"Group element in the sequence of type Donut grouped by the donut name = $donutsGroup2"
  )
}
