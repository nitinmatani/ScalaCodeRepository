...
object Collect_Tutorial extends App {
  ...
  val donutNamesandPrices: Seq[Any] =
    Seq("Plain Donut", 1.5, "Strawberry Donut", 2.0, "Glazed Donut", 2.5)
  ...
  val donutNames: Seq[String] = donutNamesandPrices.collect {
  ...
  val donutPrices: Seq[Double] = donutNamesandPrices.collect {
    case price: Double => price
  }
