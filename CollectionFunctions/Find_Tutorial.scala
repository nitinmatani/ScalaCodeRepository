...
object Find_Tutorial extends App {
  ...
  val plainDonut: Option[String] =
    donuts.find(donutName => donutName == "Plain Donut")
...
//  println(s"Find Vanilla Donuts = $vanillaDonut")
  ...
  val vanillaDonut2: String =
    donuts.find(_ == "Vanilla Donut").getOrElse("Vanilla Donut was not found!")
