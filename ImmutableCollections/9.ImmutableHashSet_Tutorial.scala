...
object ImmutableHashSet_Tutorial extends App {
  ...
  val hashSet1: HashSet[String] =
    HashSet("Plain Donut", "Strawberry Donut", "Chocolate Donut")
  ...
  val hashSet3: HashSet[String] = hashSet1 ++ HashSet[String](
    "Vanilla Donut",
    "Glazed Donut"
  )
  ...
  val hashSet5: HashSet[String] =
    HashSet("Vanilla Donut", "Glazed Donut", "Plain Donut")
