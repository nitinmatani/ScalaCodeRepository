...
object ImmutableSortedSet_Tutorial extends App {
  ...
  val sortedSet1: SortedSet[String] =
    SortedSet("Plain Donut", "Strawberry Donut", "Chocolate Donut")
  ...
  val sortedSet2
      : SortedSet[String] = sortedSet1 + "Vanilla Donut" + "Vanilla Donut"
  ...
  val sortedSet3: SortedSet[String] = sortedSet1 ++ SortedSet[String](
    "Vanilla Donut",
    "Glazed Donut"
  )
  ...
  val sortedSet5: SortedSet[String] =
    SortedSet("Vanilla Donut", "Glazed Donut", "Plain Donut")
  println(
    s"Intersection of sortedSet1 and sortedSet5 = ${sortedSet1 & sortedSet5}"
  )
  ...
  println(
    s"Difference of sortedSet1 and sortedSet5 = ${sortedSet1 &~ sortedSet5}"
  )
  ...
  val sortedSet6: SortedSet[String] =
    SortedSet("Plain Donut", "Strawberry Donut", "Chocolate Donut")(
      AlphabetOrdering
    )
