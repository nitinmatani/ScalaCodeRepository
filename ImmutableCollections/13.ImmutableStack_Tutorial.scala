...
object ImmutableStack_Tutorial extends App {
  ...
  val stack1: Stack[String] =
    Stack("Plain Donut", "Strawberry Donut", "Chocolate Donut")
  println(s"Elements of stack1 = $stack1")

  println("\nStep 2: How to initialize a Stack using an Immutable List")
  val stack2: List[String] =
    List("Plain Donut", "Strawberry Donut", "Chocolate Donut")
  ...
  println(
    s"Using an Immutable List for stack, elements after pushing N elements  = $stack4"
  )
  ...
  println(
    s"Using an Immutable List for stack, elements after tail function to simulate Stack pop = $stack5"
  )
