...
object MutableSortedSet_Tutorial extends App {
  ...
  println(
    s"Elements of sortedSet1 after adding Vanilla Donut element = $sortedSet1"
  )
  ...
  val sortedSet2: SortedSet[String] =
    SortedSet("Vanilla Donut", "Glazed Donut", "Plain Donut")
  println(
    s"Intersection of sortedSet1 and sortedSet5 = ${sortedSet1 & sortedSet2}"
  )
  ...
  println(
    s"Difference of sortedSet1 and sortedSet5 = ${sortedSet1 &~ sortedSet2}"
  )
