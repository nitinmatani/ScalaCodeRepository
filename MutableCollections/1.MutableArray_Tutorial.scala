...
object MutableArray_Tutorial extends App {
  ...
  val array1: Array[String] =
    Array("Plain Donut", "Strawberry Donut", "Chocolate Donut")
  ...
  val row1 = 1
  val column3 = 3
  val arrayOfOneRowAndThreeColumns =
    Array.tabulate(row1, column3)((row, column) => row + column)
  println(
    s"Array with 1 row and 3 columns = ${arrayOfOneRowAndThreeColumns.deep.toString}"
  )

  val row2 = 2
  val arrayOfTowRowsAndThreeColumns =
    Array.tabulate(row2, column3)((row, column) => row + column)
  println(
    s"Array with 2 rows and 3 columns = ${arrayOfTowRowsAndThreeColumns.deep.toString}"
  )

  val row3 = 3
  val arrayOfThreeRowsAndThreeColumns =
    Array.tabulate(row3, column3)((row, column) => row + column)
  println(
    s"Array with 3 rows and 3 columns = ${arrayOfTowRowsAndThreeColumns.deep.toString}"
  )
  ...
  println(
    s"copy of range array with elements from rangeArray = ${copyOfRangeArray.mkString(", ")}"
  )
  ...
  println(
    s"original range array still unchanged = ${rangeArray.mkString(", ")}"
  )
  ...
  val arrayToCompare =
    Array[String]("Plain Donut", "Strawberry Donut", "Chocolate Donut")
