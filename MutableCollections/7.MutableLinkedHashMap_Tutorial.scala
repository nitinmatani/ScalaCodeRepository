...
object MutableLinkedHashMap_Tutorial extends App {
  ...
  val linkedHashMap1: LinkedHashMap[String, String] = LinkedHashMap(
    "PD" -> "Plain Donut",
    "SD" -> "Strawberry Donut",
    "CD" -> "Chocolate Donut"
  )
  ...
  val linkedHashMap2: LinkedHashMap[String, String] =
    LinkedHashMap("VD" -> "Vanilla Donut", "GD" -> "Glazed Donut")
  ...
  val emptyLinkedHashMap: LinkedHashMap[String, String] =
