...
object PriorityQueue_Tutorial extends App {
  ...
  println(
    s"Elements of priorityQueue1 after enqueue function is called = $priorityQueue1"
  )
  ...
  println(
    s"Elements of priorityQueue1 after dequeued function is called = $priorityQueue1"
  )
